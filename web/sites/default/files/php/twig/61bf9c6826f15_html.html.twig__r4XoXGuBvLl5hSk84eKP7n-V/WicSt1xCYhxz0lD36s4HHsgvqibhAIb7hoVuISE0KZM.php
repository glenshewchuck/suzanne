...
class __TwigTemplate_2f8a1202cceea95db8488832e87c212fd00d30f249bb99d407d76232cf1002c0 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["page_title"] ?? null), twig_get_array_keys_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["node"] ?? null), "field_dth_hide_regions", [], "any", false, false, true, 65), "getValue", [], "any", false, false, true, 65), 65, $this->source)))) ? ("body--primary-tabs-float") : (""))];
        ...
        if (($context["body_bg_image_path"] ?? null)) {
            // line 69
            echo "  ";
            $context["style"] = (("background-image:url(" . call_user_func_array($this->env->getFunction('file_url')->getCallable(), [$this->sandbox->ensureToStringAllowed(($context["body_bg_image_path"] ?? null), 69, $this->source)])) . ");");
            // line 70
            echo "  ";
...
";
    ...
    {
        return new Source("", "themes/contrib/dxpr_theme/templates/html.html.twig", "/Users/glenshewchuck/Sites/suzanne/web/themes/contrib/dxpr_theme/templates/html.html.twig");
    }
