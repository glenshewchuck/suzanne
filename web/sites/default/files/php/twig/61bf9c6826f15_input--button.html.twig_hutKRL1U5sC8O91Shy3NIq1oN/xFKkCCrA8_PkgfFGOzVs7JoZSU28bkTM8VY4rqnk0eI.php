...
class __TwigTemplate_de2083ec31e302c6e274a7b8a31764e108f6b661b598d152a6e65ef1a99add0f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/input/input--button.html.twig", "/Users/glenshewchuck/Sites/suzanne/web/themes/contrib/bootstrap/templates/input/input--button.html.twig");
    }
